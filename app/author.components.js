System.register(['angular2/core', './author.service'], function(exports_1, context_1) {
    ...
    return {
        ...
        execute: function() {
            AuthorComponents = (function () {
                function AuthorComponents(authorService) {
                    this.authors = authorService.getAuthors();
                }
                AuthorComponents = __decorate([
                    core_1.Component({
                        selector: 'authors',
            ...
            exports_1("AuthorComponents", AuthorComponents);
        }
    }
});
